...
import { contactSubmit } from "@/lib/actions/contact.actions";
...
export function ContactForm() {
  const [state, formAction] = useFormState(contactSubmit, {
    success: false,
    message: "",
    errors: {},
  });
  ...
  useEffect(() => {
    ...
    showSuccessToast({ message: state?.message, position: "top-center" });
  }, [state]);
    ...
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:px-6 md:py-20 lg:grid-cols-2">
      <div className="relative flex flex-col items-center overflow-hidden lg:items-start">
        ...
        <p className="mt-8 max-w-lg text-center text-base text-neutral-600 dark:text-neutral-400 md:text-left">
          If you are part of our team or looking for our services, contact us
          and we&apos;ll help you.
        </p>
  ...
  return (
    ...
    >
      <div className="h-full w-full">
        ...
        <>
          <motion.div className="absolute bottom-1/2 left-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-blue-500 blur-[2px]" />
          <motion.div className="absolute bottom-1/2 left-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-blue-500" />
          <motion.div className="absolute bottom-1/2 left-1/2 z-40 h-[4px] w-[4px] translate-x-[1.5px] translate-y-[14px] rounded-full bg-blue-600 blur-[3px]" />
          <motion.div className="absolute bottom-1/2 left-1/2 z-40 h-[2px] w-[2px] translate-x-[0.5px] translate-y-[14px] rounded-full bg-blue-300" />
        </>
      </div>
    </motion.div>
  );
