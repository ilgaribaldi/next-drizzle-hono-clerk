...
export function DataTableViewOptions<TData>({
  ...
  useEffect(() => {
    // Set initial visibility for createdAt and updatedAt

    const createdAtColumn = table.getColumn("createdAt");
    const updatedAtColumn = table.getColumn("updatedAt");
    if (createdAtColumn) createdAtColumn.toggleVisibility(false);
    if (updatedAtColumn) updatedAtColumn.toggleVisibility(false);
  }, [table]);
      ...
      <PopoverContent side="bottom" align="end" className="w-[200px] p-0">
        <Command>
          ...
          <CommandList>
            ...
            {hasChanges && (
              <CommandGroup>
                <CommandItem onSelect={resetToDefault}>
